...
const Cart = () => {
    ...
    const handleQty = (e, itemId) => {
        ...
        setQuantity(prev => ({...prev, [itemId]: neqQty}))
    ...
    <Layout>
        <div className='container pb-5'>
            <div className='row'>
                ...
                <div className='col-md-12'>
                    <h2 className='border-bottom pb-3'>Giỏ hàng</h2>
                        ...
                        <tbody>
                            {
                                cartData.length == 0 && 
                                <tr>
                                    <td align='center' valign='middle' colSpan={4} style={{height:200}}>Giỏ hàng trống</td>
                                </tr>
                            }
                            {
                ...
                <div className='row justify-content-end'>
                    <div className='col-md-3'>
                        ...
                        <div className='d-flex justify-content-end py-3'>
                            <Link to={`/checkout`} className='btn btn-primary'>Đặt hàng</Link>
                        </div>
                    </div>
                </div>
            }
