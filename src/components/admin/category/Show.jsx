        ...
        <div className='container'>
            <div className='row'>
                <div className='d-flex justify-content-between mt-5 pb-3'>
                    <h4 className='h4 pb-0 mb-0'>Danh mục sản phẩm</h4>
                    <Link to="/admin/categories/create" className='btn btn-primary'>Tạo mới</Link>
                </div>
                ...
                <div className='col-md-9'>
                    <div className='card shadow'>
                        <div className='card-body p-4'>
                            ...
                            {
                                loader == false && categories.length == 0 && <Nostate text="Không có danh mục sản phẩm"/>
                            }
                                                        ...
                                                        <td>
                                                            ...
                                                            <Link className='text-danger ms-2' onClick={() => deleteCategory(category.id)}>
                                                                <svg xmlns="http://www.w3.org/2000/svg" width="20" 
                                                                    height="20" fill="currentColor" className="bi bi-trash3" viewBox="0 0 16 16">
