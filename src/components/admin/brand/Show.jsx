        ...
        <div className='container'>
            <div className='row'>
                <div className='d-flex justify-content-between mt-5 pb-3'>
                    <h4 className='h4 pb-0 mb-0'>Thương hiệu</h4>
                    <Link to="/admin/brands/create" className='btn btn-primary'>Tạo mới</Link>
                </div>
                ...
                <div className='col-md-9'>
                    <div className='card shadow'>
                        <div className='card-body p-4'>
                            ...
                            {
                                loader == false && brands.length == 0 && <Nostate text="Không có thương hiệu!"/>
                            }
